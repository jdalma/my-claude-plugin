...
async function main() {
    ...
    api.command('send-message')
        .description('[mutating] Send a peer message — drops a spool file, appends sender archive, records sent_pending. Add "to_team":"<team name>" to reach a worker in another running team.')
