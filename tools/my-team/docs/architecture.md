...
>
> **시각 다이어그램**: [`diagrams/communication-flow.excalidraw`](diagrams/communication-flow.excalidraw)는 옵션 B 이전(채널 4개 시대)을 묘사한다. peer mailbox 사이클(§3 이하)은 그대로 유효하지만 user→worker free-form 레인은 폐기됐다.
